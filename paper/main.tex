...
In contrast, this work considers maintaining sorted order in arrays under \emph{batched} updates where the indices of udpated elements since the previous sort are explicitly available. This update-aware model enables coordinated repair without auxiliary data structures, and distinguishes \emph{DeltaSort} from prior adaptive sorting algorithms, incremental view maintenance techniques, and dynamic ordered data structures.

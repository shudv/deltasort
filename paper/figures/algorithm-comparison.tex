...
\node[black, anchor=west] at (8.0, \rowA + 0.25) {\scriptsize\bfseries 19};
\draw[arrow] (\xM + \arrayw + 0.1, \rowB) -- (\xO - \arrowgap, \rowB);
\node[black, anchor=west] at (8.0, \rowB + 0.25) {\scriptsize\bfseries 11};
\draw[arrow] (\xM + \arrayw + 0.1, \rowC) -- (8.8, \rowC) -- (8.8, \rowB) -- (\xO - \arrowgap, \rowB);
\node[black, anchor=west] at (8.0, \rowC + 0.25) {\scriptsize\bfseries 9};
\end{tikzpicture}

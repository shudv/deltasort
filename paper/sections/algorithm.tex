...
\begin{proof}
Phase~1 stores $k$ updated indices and $k$ updated values. Phase~2 maintains a pending stack of at most $k$ indices. The internal sorting routing is also assumed to use $O(k)$ space. Therefore, the total auxiliary space is $O(k)$.
\end{proof}

...
\usepackage{placeins}
\usepackage{float}
\definecolor{avinashcolor}{rgb}{0.37, 0.29, 0.95}
\newcommand{\avinash}[1]{{\color{avinashcolor} #1}}
...
\subsection{Key Insight: \emphOO(n{Segmentation enables localized repair}}
\label{sec:insight}

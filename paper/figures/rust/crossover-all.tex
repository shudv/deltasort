...
\begin{axis}[
    ...
    legend style={font=\small, fill=white, fill opacity=0.95, draw=gray!50, legend columns=-1},
    grid=both,
...
\end{axis}
\end{tikzpicture}
\caption{Crossover thresholds for update-aware algorithms versus FullSort}

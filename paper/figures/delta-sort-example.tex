...
\draw[rarrow] (p5.south) to node[font=\tiny, black, left, pos=0.8] {\#3 [6,6]} (f5.north);
\draw[larrow, bend left=12] (p7.south) to node[font=\tiny, black, right, pos=0.2] {\#4 [5,6]} (f6.north);

...
% Input: 0 4 2 4 5 9 3 8 (centered vertically between the 3 algo rows)
\foreach \i/\v/\up in {0/0/0, 1/4/1, 2/2/0, 3/4/0, 4/5/0, 5/9/1, 6/3/1, 7/8/0} {
    \ifnum\up=1
...
\foreach \i/\v/\up in {0/0/0, 1/2/0, 2/4/0, 3/5/0, 4/8/0, 5/4/1, 6/9/1, 7/3/1} {
    \ifnum\up=1
...
\node[black, anchor=west] at (7.8, \rowB + 0.25) {\scriptsize\bfseries 16, 3};

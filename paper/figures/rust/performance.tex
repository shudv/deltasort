...
\end{tikzpicture}
\end{minipage}
\caption{Rust benchmark results. (a)~Execution time for $n=100$K on log-log scale. (b)~Crossover thresholds ($k_c/n$) where each algorithm loses to FullSort. DeltaSort occupies the middle ground: faster than BIS for large $k$, uses less space than ESM.}

...
\draw[orange!60, densely dashed, line width=0.8pt] (axis cs:36,5) -- (axis cs:36,100000);
\draw[green!50!black, densely dashed, line width=0.8pt] (axis cs:24900,5) -- (axis cs:24900,100000);
\draw[purple!50, densely dashed, line width=0.8pt] (axis cs:72367,5) -- (axis cs:72367,100000);

% Crossover labels (above and left of lines)
\node[font=\tiny, orange!80!black, anchor=south east] at (axis cs:50,4.3) {.04\%};
\node[font=\tiny, green!60!black, anchor=south east] at (axis cs:34900,4.3) {25\%};
\node[font=\tiny, purple!70, anchor=south east] at (axis cs:400974,4.3) {72\%};
...
\node[font=\tiny, green!60!black, anchor=west] at (axis cs:110000,31) {25\%};
\node[font=\tiny, purple!70, anchor=west] at (axis cs:110000,78) {72\%};

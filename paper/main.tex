...
% ---------------- Metadata ----------------
\title{DeltaSort: Fast incremental batched repair of sorted arrays under sparse updates}
\author{
  Shubham Dwivedi \\
...
Sorted sequences are a foundational structure in software systems. User
...
The correctness of DeltaSort follows from three invariants which are maintained throughout
execution.
...
Future work includes tighter theoretical bounds on movement costs, comparison against 
fully instrumented reference sorting algorithms, and adaptive heuristics for selecting
between DeltaSort and native sorting based on observed update patterns.

...
Since no value exits its segment, segments can be repaired independently. Next, we stablish an asymptotic bound on number of movements during repair.
\end{proof}

...
\vspace{0.3em}
\ref{jslegend}
\caption{JavaScript/V8 benchmark results. (a)~Execution time for $n=100$K. Note the high variance compared to Rust benchmarks. (b)~Crossover thresholds. ESM is faster up to $\approx 75\%$, while BIS and DeltaSort thresholds are much lower than in Rust.}

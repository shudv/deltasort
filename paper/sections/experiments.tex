...
We evaluate these algorithms under fully random update distributions, which provide no favorable structure to any particular algorithm. Comparisons are performed using a multi-key comparator, reflecting a realistic comparison cost. We evaluate following algorithms:

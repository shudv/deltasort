...
DeltaSort is an in-place update-aware sorting algorithm. It operates in two phases (see \algoref{alg:deltasort} for pseudocode). The first phase establishes a structure among updated values, and the second phase exploits this structure to efficiently sort the array.

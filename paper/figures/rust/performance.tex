...
\draw[orange!60, densely dashed, line width=0.8pt] (axis cs:34,5) -- (axis cs:34,100000);
\draw[green!50!black, densely dashed, line width=0.8pt] (axis cs:17236,5) -- (axis cs:17236,100000);
\draw[purple!50, densely dashed, line width=0.8pt] (axis cs:80823,5) -- (axis cs:80823,100000);

% Crossover labels (above and left of lines)
\node[font=\tiny, orange!80!black, anchor=south east] at (axis cs:50,4.3) {.03\%};
\node[font=\tiny, green!60!black, anchor=south east] at (axis cs:24000,4.3) {17\%};
\node[font=\tiny, purple!70, anchor=south east] at (axis cs:400974,4.3) {81\%};
...
\node[font=\tiny, orange!80!black, anchor=west] at (axis cs:110000,6) {.03\%};
\node[font=\tiny, green!60!black, anchor=west] at (axis cs:110000,22) {17\%};
\node[font=\tiny, purple!70, anchor=west] at (axis cs:110000,85) {81\%};

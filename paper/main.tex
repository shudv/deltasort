...
\begin{itemize}
  ...
  \item \textbf{RIGHT (R)}: Element is locally ordered with its left neighbor. It may need to move right, or may already be correctly placed. We classify all non-LEFT updates as RIGHT because a currently stable element can become displaced when a preceding RIGHT is fixed.
\end{itemize}
\end{definition}

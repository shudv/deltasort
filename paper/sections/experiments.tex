...
\begin{enumerate}
  ...
  \item Crossover threshold trend that is consistent and largely stable across all scales (DeltaSort 20--40\%, ESM 60--80\%). BIS has a very low threshold due to its high quadratic data movement cost, whereas ESM achieves the highest crossover threshold due to its efficient linear merge pass. DeltaSort exhibits an intermediate threshold, in line with it's theoretical asymptotic complexity.
\end{enumerate}

...
All experiments are run using a Rust implementation of DeltaSort on a synthetic dataset
...
Correctness is verified by an extensive set of randomized unit tests across various scales and
...
\end{axis}
\end{tikzpicture}
\caption{Comparator invocation count for $n = 50{,}000$ elements. DeltaSort and BI
...
and BI confirm that DeltaSort's speedup derives from movement efficiency, not fewer
comparisons.}
...
DeltaSort was also implemented in JavaScript running on Node.js v20 (V8 engine). While

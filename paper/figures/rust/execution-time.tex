...
\end{axis}
\end{tikzpicture}
\caption{Execution time comparison for $n = 100$K (log-log scale). The red circles indicate the crossover points where each update-aware algorithm is outperformed by FullSort.}

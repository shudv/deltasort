...
None of the incremental algorithms studied here (BIS, DeltaSort, ESM) guarantee \emph{stability}. The impact of guaranteeing stability on performance and complexity of update-aware algorithms needs to be studied.

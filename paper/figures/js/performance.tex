...
\vspace{0.3em}
\ref{jslegend}
\caption{JavaScript/V8 benchmark results. (a)~Execution time for $n=100$K. Note that DeltaSort and BIS overlap---V8's memory model does not reflect physical movement costs. (b)~Crossover thresholds. ESM is faster up to $\approx 40\%$, while BIS/DeltaSort thresholds are much lower.}

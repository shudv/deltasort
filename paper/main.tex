...
Native sort? We conducted a binary search for the crossover point $k_c$ across array
...
We also implemented DeltaSort in TypeScript running on Node.js v20 (V8 engine). While
...
remains faster in our measurements.
...
Based on our Rust benchmarks across array sizes from 1K to 1M elements:
...
ranging from 15\% to 31\% in our experiments (Table~\ref{tab:crossover}).
...
Our TypeScript/Node.js implementation shows higher variance due to JIT compilation,

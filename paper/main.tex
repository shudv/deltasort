...
\[
\Pr[\mathrm{LR} \text{ at } (i, i+1)] = \Pr[\mathrm{L \ at\ } i] \cdot \Pr[\mathrm{R \ at\ } i+1] = \frac{i}{k-1} \cdot \frac{k-2-i}{k-1} = \frac{i(k-2-i)}{(k-1)^2}. \]
...
\[
\sum_{i=0}^{k-2} i(k-2-i) = \frac{(k-1)(k-2)(k-3)}{6},
\]
and therefore
\[

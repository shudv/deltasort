...
The results confirm both bounds: movement normalized by $n\sqrt{k}$ converges to approximately~$0.4$ across four orders of magnitude of~$n$, and comparisons normalized by $k\log n$ converge to approximately~$2$. The overlap of curves for different~$n$ validates that the asymptotic analysis correctly captures the algorithm's behavior.

...
DeltaSort is an insertion-based update-aware sorting algorithm. In the following sections, we first give an overview of the algorithm, then formally prove its correctness, and finally analyze its expected complexity under a random update model.

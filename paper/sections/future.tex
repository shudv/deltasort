...
Finally, while this paper treats DeltaSort as a standalone algorithm for analysis, practical systems would benefit from \emph{adaptive update-aware strategies} that select among BIS, DeltaSort, ESM, and full re-sorting based on the update batch size and system constraints. Designing heuristic-based, low-overhead mechanisms for such dynamic selection is an open challenge.

...
\begin{axis}[
    ...
    legend style={font=\scriptsize, fill=white, fill opacity=0.85, draw=gray!50, legend columns=3, xshift=-2pt, yshift=2pt, legend cell align=left, /tikz/every even column/.append style={column sep=2pt}},

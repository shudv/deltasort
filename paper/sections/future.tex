...
None of the incremental algorithms studied here (BIS, DeltaSort, ESM) guarantee \emph{stability}. The impact of guaranteeing stability on performance and complexity needs to be studied because stability is a critical property for many practical applications.

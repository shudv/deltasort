...
\begin{remark}
The above model is general enough to be applicable to not just primitive types but also keyed-records. The application layer needs to maintain the mapping from keys to indices in the array (extra $O(n)$ space), and provide an appropriate comparator that compares records based on the desired sort key.
\end{remark}
